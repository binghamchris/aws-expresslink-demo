...
### Configure the wifi connection on the Demo Badge
...
### Get the certificate and device name information from the Demo Badge
...
### Deploy the CloudFormation template to your AWS account, providing the parameters retrieved in step two
...
### Configure the AWS IoT Core endpoint on the Demo Badge
